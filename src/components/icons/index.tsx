...
export function SaturatedFatIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <circle cx="24" cy="24" r="22" fill="#FBE9E7" stroke="#FF5722" strokeWidth="2"/>
      <path d="M16 20C16 16 20 12 24 12C28 12 32 16 32 20C32 28 24 36 24 36C24 36 16 28 16 20Z" fill="#FF8A65"/>
...
export function SugarIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <circle cx="24" cy="24" r="22" fill="#FCE4EC" stroke="#E91E63" strokeWidth="2"/>
...
export function CarbsIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <circle cx="24" cy="24" r="22" fill="#FFF8E1" stroke="#FFC107" strokeWidth="2"/>
      <ellipse cx="24" cy="24" rx="12" ry="10" fill="#FFD54F"/>
      <path d="M14 22C14 22 18 18 24 18C30 18 34 22 34 22" stroke="#FF8F00" strokeWidth="2" strokeLinecap="round"/>
      <path d="M16 26C16 26 20 30 24 30C28 30 32 26 32 26" stroke="#FF8F00" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  );
}
...
export function CholesterolIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      <path d="M20 18L24 24L28 18" stroke="#2E7D32" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M20 30L24 24L28 30" stroke="#2E7D32" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function SodiumIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <circle cx="24" cy="24" r="22" fill="#E3F2FD" stroke="#2196F3" strokeWidth="2"/>
      <path d="M20 14L20 34" stroke="#64B5F6" strokeWidth="3" strokeLinecap="round"/>
      <path d="M28 14L28 34" stroke="#64B5F6" strokeWidth="3" strokeLinecap="round"/>
...
export function ProteinIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <circle cx="24" cy="24" r="22" fill="#EDE7F6" stroke="#673AB7" strokeWidth="2"/>
...
export function FiberIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      <circle cx="24" cy="24" r="22" fill="#F1F8E9" stroke="#8BC34A" strokeWidth="2"/>
      <path d="M24 12C24 12 28 16 28 24C28 32 24 36 24 36" stroke="#7CB342" strokeWidth="3" strokeLinecap="round"/>
      <path d="M18 18C18 18 22 20 24 24" stroke="#9CCC65" strokeWidth="2" strokeLinecap="round"/>
      <path d="M30 20C30 20 26 22 24 26" stroke="#9CCC65" strokeWidth="2" strokeLinecap="round"/>
      <path d="M16 26C16 26 20 26 24 28" stroke="#9CCC65" strokeWidth="2" strokeLinecap="round"/>
    </svg>
  );
}
...
export function MainCharacter({ className, size = 200 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 200 200" fill="none" className={className}>
      ...
      {/* 입 */}
      <path d="M72 115 Q80 122 88 115" stroke="#333333" strokeWidth="2" fill="none" strokeLinecap="round"/>
      ...
      {/* 팔 */}
      <ellipse cx="35" cy="130" rx="12" ry="20" fill="#9F85E3" transform="rotate(-20 35 130)"/>
      <ellipse cx="125" cy="130" rx="12" ry="20" fill="#9F85E3" transform="rotate(20 125 130)"/>
    </svg>
  );
}
...
export function DoctorCharacter({ className, size = 80 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 80 80" fill="none" className={className}>
      ...
      {/* 입 */}
      <path d="M36 42 Q40 46 44 42" stroke="#333333" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
...
export function SupplementIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <rect x="6" y="4" width="12" height="16" rx="4" stroke="currentColor" strokeWidth="2"/>
...
export function AttendanceIcon({ className, size = 32 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      <path d="M17 24L22 29L32 19" stroke="#4CAF50" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
export function StepsMenuIcon({ className, size = 32 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      <ellipse cx="20" cy="16" rx="6" ry="8" fill="#03A9F4" transform="rotate(-15 20 16)"/>
      <ellipse cx="28" cy="32" rx="6" ry="8" fill="#03A9F4" transform="rotate(15 28 32)"/>
    </svg>
  );
}
...
export function AIDoctorIcon({ className, size = 32 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className}>
      ...
      <path d="M22 25 Q24 28 26 25" stroke="#333333" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
...
export function PointIcon({ className, size = 20 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <circle cx="12" cy="12" r="10" fill="#FFD700" stroke="#FFA000" strokeWidth="1"/>
      <text x="12" y="16" textAnchor="middle" fontSize="12" fontWeight="bold" fill="#8B4513">P</text>
    </svg>
  );
}
...
export function WaterIcon({ className, size = 24 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className}>
      <path d="M12 2C12 2 6 10 6 14C6 17.3137 8.68629 20 12 20C15.3137 20 18 17.3137 18 14C18 10 12 2 12 2Z" fill="#64B5F6" stroke="#2196F3" strokeWidth="1.5"/>
