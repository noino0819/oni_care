...
function BannerCharacter1() {
  return (
    <svg width="70" height="70" viewBox="0 0 70 70" fill="none">
      ...
      {/* 입 */}
      <path d="M32 36 Q35 39 38 36" stroke="#333333" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
...
function BannerCharacter2() {
  return (
    <svg width="70" height="70" viewBox="0 0 70 70" fill="none">
      {/* 요리사 모자 */}
      <ellipse cx="35" cy="12" rx="16" ry="8" fill="#FFFFFF" stroke="#E0E0E0" strokeWidth="1"/>
      ...
      {/* 입 */}
      <path d="M32 38 Q35 41 38 38" stroke="#333333" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
